...
// TODO:
// Replace this by a better breadcrumb which will be global to certain landing pages.
// This will be done to keep things consistent. Consider adding a description property also.
// You may use the image paths (without assests folder), which have a nice educational touch:
// image1 = images/shapes/shape1.png
