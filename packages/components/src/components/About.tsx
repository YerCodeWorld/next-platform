...
const Shape2 = '/images/shapes/shape2.png';
const Shape6 = '/images/shapes/shape6.png';
const Shape7 = '/images/shapes/shape7.png';

const AboutImg1 = '/images/thumbs/about-img1.png';
const AboutImg2 = '/images/thumbs/about-img2.png';

const AboutIcon1 = '/images/icons/about-img1.png';
const AboutIcon2 = '/images/icons/about-img2.png';

const CeoImg = '/images/thumbs/ceo_img.jpeg';
                                ...
                                <div className='about-content'>
                                    ...
                                    >
                                        ...
                                        <div className='flex-align gap-20'>
                                            ...
                                            />
                                            <div className='flex-grow-1'>
                                                <h3 className={"m-0"}>Yahir Adolfo Beras </h3>
                                                <span className='text-sm d-block ml-1'>EduPlatform CEO</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
