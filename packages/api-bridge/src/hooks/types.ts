...
// Base types
export type ExerciseType = 'FILL_BLANK' | 'MATCHING' | 'MULTIPLE_CHOICE' | 'ORDERING' | 'LETTER_SOUP';
...
// Letter Soup (Word Search) content type - SIMPLIFIED
export interface LetterSoupContent {
    words: string[];                // Simple array of words to find
    gridSize?: number;              // Grid size (square grid)
    caseSensitive?: boolean;        // Default false
    allowBackwards?: boolean;       // Default false
    theme?: string;                 // Optional theme description
    placementDifficulty?: 'easy' | 'medium' | 'hard'; // Affects word placement
}
