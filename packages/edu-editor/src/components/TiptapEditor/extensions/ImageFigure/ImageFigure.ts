...
import { NodeSelection, Plugin} from "@tiptap/pm/state";  // removed TextSelection
                ...
                props: {
                    handleDOMEvents: {
                        dragstart: (view, event) => {
                            ...
                            // Use a safer approach to handle clipboard serialization
                            // Instead of using the private API
                            const slice = draggedNode.content();
                            const dom = document.createElement('div');
                            // const fragment = slice.content.toDOM(view.domParser.schema);
